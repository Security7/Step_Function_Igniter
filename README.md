...
This Lambda Function is used by CloudFormation when a stack is created for the first time. When invocked by CF, it will automatically start the Step Function, which will immedialtry start procesing all the logs.
